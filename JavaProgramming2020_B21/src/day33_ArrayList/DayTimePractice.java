...
import day32_localDate_WraperClass.Date;
 ...
 */
        ...
        System.out.println("=================================");
/*
2. create an array of LocalDate and store the next 10 day's dates, use for each loop to print
each Date in the following formar:
                MonthName/Day, Name
                ex:
