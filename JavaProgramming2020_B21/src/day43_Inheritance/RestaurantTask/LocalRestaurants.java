...
public class LocalRestaurants {
    public static void main(String[] args) {
        ...
        restaurant.hireSever( new Server("Mini", 25, 'F', 35, "Server4", "S006"));
                                        // this method adds ONLY Mini as Server
        restaurant.hireServer(servers); // this method adds ALL (5) Servers
        ...
        System.out.println("budget for servers = " + budget);
        ...
        System.out.println("budget for Chefs = " + budget);
