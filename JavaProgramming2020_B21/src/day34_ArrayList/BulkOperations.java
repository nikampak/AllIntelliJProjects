...
public class BulkOperations {
    public static void main(String[] args) {
        ...
        // verify if 10, 30, 50 & 60 all are contained in the lost
        boolean r3 =    list.containsAll(   Arrays.asList( 10, 30, 50, 60 )   ); // false
        ...
        System.out.println(chars); //[A, Z, C, B, H, I, K]
        ...
        System.out.println(ch1); // [A, B, C, D, E, J, K, L, M, N]
        ...
        */
        ...
        System.out.println(employees);  // [Erjon, Adil, Afrooz]
...
//
        ...
        System.out.println(employees2); // [Ahmed, Ahmed, Ahmed, Ahmed]
